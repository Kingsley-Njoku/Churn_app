...
# app.py – Professional UI version with SHAP
...
@st.cache_resource
def load_pipeline():
    model_path = "churn_pipeline_v1.joblib"  # adjust if different
...
st.markdown(
    ...
    <h2 style="color:white;text-align:center;">📊 Customer Churn Predictor</h2>
...
if uploaded_file:
    try:
        ...
        # Tabs for workflow
        tab1, tab2, tab3 = st.tabs(["🔍 Predictions", "🧐 Explain Prediction", "⬇️ Export"])
        ...
        with tab2:
            ...
            with st.spinner("Computing SHAP explanations..."):
                ...
                if preprocessor is None or classifier is None:
                    st.warning("Preprocessor or classifier not found in pipeline — cannot compute SHAP.")
                else:
